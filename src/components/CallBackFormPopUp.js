...
export default function CallBackFormPopUp(props) {
  ...
  const handleSubmit = e => {
    ...
    headers.append(
      ...
      "Basic " +
        base64.encode(
          "ck_5ca5ca00f9399ba135f371f70b4f5c8d687b8005" +
            ":" +
            "cs_cc05ffea5f0f673c02a868c8a34021578775c359"
        )
    )

    const getMessage = () => {
      fetch("https://meek-hint.flywheelsites.com/wp-json/gf/v2/forms/2", {
        method: "GET",
        headers: headers,
      })
        ...
        .then(data => {
          ...
          setTermsCheck(false)
          return setMessage(
            data.confirmations[Object.entries(data.confirmations)[0][0]][
              "message"
            ]
          )
        })
        ...
        >
          <div className="gform_body">
            ...
            >
              <li
                id="field_2_8"
                className="gfield gform_hidden field_sublabel_below field_description_below gfield_visibility_visible"
              >
                <input
                  name="input_8"
                  id="input_2_8"
              ...
              <li
                id="field_2_1"
                className="gfield field_sublabel_below field_description_below hidden_label gfield_visibility_visible"
              >
                <label className="gfield_label" for="input_2_1">
                  Name
                </label>
              ...
              <li
                ...
                className="gfield field_sublabel_below field_description_below hidden_label gfield_visibility_visible"
              >
                <label className="gfield_label" for="input_2_3">
                  Country
                </label>
              ...
              <li
                ...
                className="gfield field_sublabel_below field_description_below hidden_label gfield_visibility_visible"
              >
                <label className="gfield_label" for="input_2_11">
                  Email
                </label>
              ...
              <li
                ...
                className="gfield field_sublabel_below field_description_below hidden_label gfield_visibility_visible"
              >
                <label className="gfield_label" for="input_2_12">
                  Phone
                </label>
              ...
              >
                <label
                  ...
                  style={showReqMessage ? { color: "red" } : {}}
                >
                  Accept Terms<span className="gfield_required">*</span>
                </label>
                  ...
                  <ul className="gfield_checkbox" id="input_2_6">
                    <li className="gchoice_2_6_1 callback-form--terms">
                      <input
                        ...
                        value={`I hereby accept that my data is sent to ${brokerName} and agree to the terms and conditions of wecomparebrokers and ${brokerName}`}
                        id="choice_2_6_1"
                      />
                      <label
                        for="choice_2_6_1"
                        ...
                        style={showReqMessage ? { color: "red" } : {}}
                      >
                        I hereby accept that my data is sent to {brokerName} and
                        agree to the {termsLink} of wecomparebrokers and{" "}
                        {brokerName}
                      </label>
                    </li>
                  </ul>
          ...
          <div className="gform_footer top_label">
            <input
              ...
              className="gform_button button btn callback-form--submit"
              value="Send Info"
            />
            <input
              type="hidden"

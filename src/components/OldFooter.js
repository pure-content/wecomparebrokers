    ...
    const TopFooterWrap = () => {
        if (contentType !== "top_brokers") {
            ...
            return ( <
                ...
                img className = "lazy left app-img"
                src = { foot_app_img }
                data - src = { foot_app_img }
                alt = "Application" /
                >
                <
                Link className = "footer-btn left"
                to = { footerOptions.appstoreButtonLink } >
                <
                img className = "lazy footer-appstore"
                src = { store_img }
                data - src = { store_img }
                alt = "AppStore" /
                >
                ...
                <
                img className = "lazy footer-playmarket"
                src = { market_img }
                data - src = { market_img }
                alt = "GooglePlay" /
                >
                ...
                /Link> < /
                div > <
                div className = "large-5 columns" > { Parser(footerOptions.newFooterSidebarContent) } <
                /div> < /
                div > <
                /div>
            )
                    ...
                    footerOptions.partnersList.map(partner => ( <
                        li key = { shortid.generate() } > {
                            partner.link && ( <
                                ...
                                target = "_blank" >
                                <
                                img src = { partner.logo.mediaItemUrl }
                                alt = "Partner" / >
                                <
                                /Link>
                            )
        ...
        const ColGenerator = (title, links, logo) => {
            ...
            return ( <
                    ...
                    gfForm ? ( <
                        ...
                        for = "input_1_1" > Email < span class = "gfield_required" > * < /span></label >
                        <
                        ...
                        type = "text"
                        class = "large"
                        placeholder = { gfForm.formFields[0].placeholder }
                        aria - required = "true"
                        aria - invalid = "false" / >
                        <
                        /div> < /
                    ...
                    footerOptions.footerText.length > 0 && ( <
                        ...
                        <
                        div className = "text-wrap" > { Parser(footerOptions.footerText) } <
                        /div> < /
                        div >
                    )
                } <
        ...
        return ( <
            ...
            div className = "row" > {
                footerOptions.copyrightOptions.length > 0 && ( <
                    ...
                    p >
                    &
                    copy; { Parser(footerOptions.copyrightOptions) } { dt.getFullYear() } <
                    /p> < /
                    div >
                )
            } <

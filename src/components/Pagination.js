    ...
    if (pageNumbers.length > 4) {
        ...
        return (
            <ul class="pagination">
                ...
                {currentPage < lastPage - 2 ? <li><span class="pagination dots">…</span></li> : null}
                {currentPage < lastPage - 1 ? <li><a class='pagination' onClick={() => setCurrentPage(lastPage)}>{lastPage}</a></li> : null}

    ...
    return (
      <>
        <span className="aff-wrap">
          <Link className="btn " to={brokerInfo.cptBrokers.affiliateLink}>
            Visit Broker
          </Link>
          ...
          <div className="img-col img-center">
            <div className="thumb-wrap">
              {brokerInfo.featuredImage ? (
                <a href={brokerInfo.cptBrokers.affiliateLink}>
                  <img
          ...
          <div className="broker-name align-right">
            <span class="rating">
              ...
              <span
                class="rat-color"
                style={{
                  width: `${avarageRatingCounter(brokerInfo.cptBrokers) * 20}%`,
                }}
              ></span>
            </span>
            <span class="rat-val">
              {isNaN(avarageRatingCounter(brokerInfo.cptBrokers))
                ? "0"
            ...
            <ul>
              {methodsList.map(method => {
                if (brokerInfo.cptBrokers.methodsList) {
                  return brokerInfo.cptBrokers.methodsList.includes(method) ? (

      ...
      <div class="row top-content">
        <div class="large-5 medium-6 columns top-content-col">
          <div class="crumbs">
            ...
            <span>{brokerComparison123.title}</span>
          </div>
          <article>
            <h3 class="page_title">
            ...
            <form action={page.uri} method="get">
              <select id="first-usr" ref={firstBrokerRef} name="first-usr">
                ...
                {data.wpgraphql.brokers123.nodes.map(broker => {
                  return (
                    <option id={`1${broker.id}`} value={JSON.stringify(broker)}>
                      {broker.title}
                    </option>
                  )
                })}
              ...
              <select id="sec-usr" ref={secondBrokerRef} name="sec-usr">
                ...
                {data.wpgraphql.brokers123.nodes.map(broker => {
                  return (
                    <option id={`2${broker.id}`} value={JSON.stringify(broker)}>
                      {broker.title}
                    </option>
                  )
                })}
      ...
      <div class="medium-6 columns">
        <div class="tabs-brok-card-wrap tabs-card">
            ...
            <div class="top-left top-cols">
              {
                <img
                  class="wp-post-image"
                  onLoad={() => $(".top-cols").matchHeight()}
                  src={firstBroker.featuredImage.node.mediaItemUrl}
                  srcSet={firstBroker.featuredImage.node.srcSet}
                  sizes={firstBroker.featuredImage.node.sizes}
                />
              }
            </div>
            <div class="top-right top-cols text-center">
              {scoreAnimation(
                firstBroker.cptBrokers.ourScore,
                "big-chart",
                true
              )}
            </div>
          ...
          <div class="brok-info-wrap">
            ...
            <div class="list-cont">
              {Parser(
                firstBroker.cptBrokers.likesList
                  ? firstBroker.cptBrokers.likesList
                  : ""
              )}
            </div>
          ...
          <div class="rat-wrap">
            <span class="rating">
              ...
              <span
                ...
                style={{
                  width: `${
                    avarageRatingCounter(firstBroker.cptBrokers) * 20
                  }%`,
                }}
              ></span>
            </span>
          ...
          <div class="btn-wrap">
            {firstBroker.cptBrokers.affiliateLink &&
            firstBroker.cptBrokers.tabButtonAlternativeText ? (
              <a
                class="btn small blue"
                href={firstBroker.cptBrokers.affiliateLink}
                target="_blank"
            ...
            <Link to={firstBroker.uri} class="btn small blue">
              Read Full Review
            </Link>
          </div>
        </div>
        {firstBroker.cptBrokers.brokerWarningMessage ? (
      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "WebPage",
            headline: brokerComparison123.title,
            url: `https://www.wecomparebrokers.com${brokerComparison123.uri}`,
          })}
        </script>
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                item: {
                  "@id": `https://www.wecomparebrokers.com${brokerComparison123.uri}`,
                  name: brokerComparison123.title,
                },
              },
            ],
          })}

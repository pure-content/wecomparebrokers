...
export default function ArchiveForexMarketNews() {
    ...
    return (
      <div class="row top-content">
        ...
        <div class="small-12 columns crypto-top-left">
          <article>
            <h1 class="page_title">
              {forexNews.wpgraphql.forexArchiveData.title}
            </h1>
            <div class="dot-sep">
              <span></span>
              <span></span>
                ...
                {currentNews.map(article => (
                  <div class="medium-6 columns">
                    <Link class="post-wrap" to={article.uri}>
                      ...
                      <h4>{article.title}</h4>
                      {article.cptForexMarketNews.forexMarketMainTextExerpt ? (
                        <p>
                          {Parser(
                            article.cptForexMarketNews.forexMarketMainTextExerpt
                              ? article.cptForexMarketNews
                                  .forexMarketMainTextExerpt
                              : ""
                          )}{" "}
                          ...
  ...
  return (
    <Layout>
      <Helmet>
        <title>Forex Market News Archive | We Compare Brokers</title>
        <meta name="description" content="" />
        <meta name="og:type" content="" />
        <meta
          name="og:title"
          content="Forex Market News Archive | We Compare Brokers"
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "WebPage",
            headline: "Forex Market News Archive",
            url: `https://www.wecomparebrokers.com/forex-market-news`,
          })}
        </script>
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                item: {
                  ...
                  name: "Forex Market News Archive",
                },
              },
            ],
          })}

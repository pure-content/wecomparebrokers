        ...
        <Layout>
            ...
            <div class="row archive-brokers-heading">
                <div class="small-12 columns">
                    {themeGeneralSettings.optGeneralSettings.brokerArchiveHeader ? <h1>{Parser(themeGeneralSettings.optGeneralSettings.brokerArchiveHeader ? themeGeneralSettings.optGeneralSettings.brokerArchiveHeader : '')}</h1> : null}
                    {themeGeneralSettings.optGeneralSettings.brokerArchiveText ? <p>{Parser(themeGeneralSettings.optGeneralSettings.brokerArchiveText ? themeGeneralSettings.optGeneralSettings.brokerArchiveText : '')}</p> : null}
                </div>
            </div>
